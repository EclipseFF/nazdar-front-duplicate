...
export default function ItemCard(props: Props) {
    ...
    return (
        <div
            className="w-[150px] h-[375px] md:w-[210px] md:h-[450px] border-2 border-[#F3F3F3] rounded-[40px] p-4 flex flex-col justify-between">
            <div className="grid justify-items-center pt-4">
                {props.Item.images && props.Item.images.length > 0 && (
                    <Image
                        src={apiUrl + "/images/" + props.Item.id + "/" + props.Item.images[0]}
                        alt={'Товар'}
                        width={120}
                        height={150}
                        quality={100}
                        objectFit="contain"
                        className="rounded-[30px] w-[115px] h-[130px] md:w-[175px] md:h-[200px]"
                    />
                )}
            </div>
            <p className="text-xs md:text-base font-semibold md:font-bold mt-2">{props.Item.name}</p>
            <p className="text-gray-400 pt-3 text-xs md:text-sm">Цена:</p>
            ...
            <div className="flex justify-center pt-4 mt-auto">
                        ...
                        <AlertDialogContent className="w-[90%] max-w-[400px] md:max-w-[600px] p-4">
                            <AlertDialogHeader>
                                <div className="flex justify-between mb-4">
                                    <AlertDialogTitle>Перед заказом, пожалуйста, зарегистрируйтесь</AlertDialogTitle>
                                    <Image
                ...
                <button
                    ...
                    className="w-[120px] h-[40px] md:w-[170px] md:h-[40px] bg-primary_purple rounded-[6px] text-white font-bold text-[10px] md:text-[12px] "
                >
                    В корзину
                </button>
            </div>
