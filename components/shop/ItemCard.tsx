    ...
    return (
        <div className="w-[150px] h-[300px] md:w-[210px] md:h-[390px] border-2 border-[#F3F3F3] rounded-[40px]" >
            <div className="grid justify-items-center pt-4">
                {props.Item.images && props.Item.images.length > 0 && <Image src={apiUrl + "/images/" + props.Item.id + "/" + props.Item.images[0]} alt={'Товар'} width={120} height={150} quality={100} objectFit="contain" className="rounded-[30px] w-[115px] h-[130px] md:w-[175px] md:h-[200px]" />}
            </div>
